...
public class TagApproaches {
    ...
    public TagApproaches() {
        ...
        tagArray[2] = new TagApproach(3, 0, 0, Alliance.Red, gameTarget.Speaker,pose, 0);
        ...
        tagArray[3] = new TagApproach(4, 0, 0, Alliance.Red, gameTarget.Speaker,pose,0);
        ...
        tagArray[8] = new TagApproach(9, 0, -0.64, Alliance.Red, gameTarget.Source, pose, 0);
        tagArray[9] = new TagApproach(10, 0, 0.64, Alliance.Red, gameTarget.Source,pose, 1);

        pose = calcNewPose(11, 0.0, 0,45);
        tagArray[10] = new TagApproach(11, 0, 0, Alliance.Red, gameTarget.Stage,pose,0);

        pose = calcNewPose(12, 0.0, 0,45);
        tagArray[11] = new TagApproach(12, 0, 0, Alliance.Red, gameTarget.Stage,pose,0);

        pose = calcNewPose(13, 0.0, 0,45);
        tagArray[12] = new TagApproach(13, 0, 0, Alliance.Red, gameTarget.Stage,pose,0);

        pose = calcNewPose(14, 0.0, 0,45);
        tagArray[13] = new TagApproach(14, 0, 0, Alliance.Blue, gameTarget.Stage,pose,0);

        pose = calcNewPose(15, 0.0, 0,45);
        tagArray[14] = new TagApproach(15, 0, 0, Alliance.Blue, gameTarget.Stage,pose,0);

        pose = calcNewPose(16, 0.0, 0,45);
        tagArray[15] = new TagApproach(16, 0, 0, Alliance.Blue, gameTarget.Stage, pose,0);
    }
    ...
    public double LimelightCrosshairOffset(int tagID){
        return tagArray[tagID = 1].LimelightCrosshairOffset();
    }
}