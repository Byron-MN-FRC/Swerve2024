...
climbL = new PWMSparkMax(9);
 ...
 climbL.setInverted(true);
    ...
    public void reverseClimb(){
        ...
        //     climbL.set(0);
        //     onWayToSecondSwitchTriggerL = false;
        //     firstTriggerL = false;
        // } else climbL.set(-Math.abs(RobotContainer.getInstance().accessory.getLeftY()));
        
        // if (onWayToSecondSwitchTriggerR && isClimbRTriggered()){
        //     climbR.set(0);
        //     onWayToSecondSwitchTriggerR = false;
        //     firstTriggerR = false;
        // } else climbR.set(-Math.abs(RobotContainer.getInstance().accessory.getRightY()));
        if (!isClimbLTriggered()) climbL.set(0);
        else climbL.set(-Math.abs(RobotContainer.getInstance().accessory.getLeftY()));
